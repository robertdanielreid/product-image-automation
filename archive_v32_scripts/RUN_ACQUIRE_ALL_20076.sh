...
"$PYTHON_BIN" "$PACKAGE_ROOT/scripts/build_review_dashboard.py" \
  --package-root "$PACKAGE_ROOT" --store-root "$STORE_ROOT"
echo "Acquisition and dashboard generation complete. Review output/manual_visual_review.csv before finalizing."
